...
function [summary_tables, comp_models] = ...
  ...
  for i=1:n_solvers
    ...
    summary_tables.normV = add_column(...
        ['min_vNorm_', solver_name], comp_model.min_norm_of_v, ...
        summary_tables.normV);
  end
  ...
  summary_tables.all = ...
    [summary_tables.pdata, summary_tables.fval, summary_tables.normV, ...
     summary_tables.iter, summary_tables.runtime, summary_tables.mdata];
