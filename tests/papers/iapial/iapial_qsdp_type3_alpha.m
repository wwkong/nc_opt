...
globals.opt_tol = 1e-5;
globals.feas_tol = 1e-5;
...
disp(tbl);
writetable(tbl, "iapial_qsdp_type3_alpha.xlsx");
...
function [out_tbl, out_models] = run_experiment(m, M, params) 
  ...
  ipla_hparam.k0_type = 1;
  
  ipla_alpha_hparam = base_hparam;
  ipla_alpha_hparam.acg_steptype = 'variable';
  ipla_alpha_hparam.k0_type = 3;
    
  ipla_alpha1E8_hparam = ipla_alpha_hparam;
  ipla_alpha1E8_hparam.k0_type3_alpha = 1E8;
  
  ipla_alpha1E9_hparam = ipla_alpha_hparam;
  ipla_alpha1E9_hparam.k0_type3_alpha = 1E9;
  
  ipla_alpha1E10_hparam = ipla_alpha_hparam;
  ipla_alpha1E10_hparam.k0_type3_alpha = 1E10;
   
  % Run a benchmark test and print the summary.
  hparam_arr = {ipla_hparam, ipla_alpha1E8_hparam, ipla_alpha1E9_hparam, ipla_alpha1E10_hparam};
  name_arr = {'IPLA', 'IPLA_alpha1E8', 'IPLA_alpha1E9', 'IPLA_alpha1E10'};
  framework_arr = {@IAIPAL, @IAIPAL, @IAIPAL, @IAIPAL};
