...
base_hparam.M0 = 1;
apgd_hparam = base_hparam;
apgd_hparam.steptype = 'adaptive';
...
for i = 1:nrows
  ...
  hparam_arr = {apgd_hparam, base_hparam, base_hparam, base_hparam};
  name_arr = {'APGD', 'UPF', 'ANCF', 'APD'};
 
%   solver_arr = {@UPFAG, @APD};
%   hparam_arr = {base_hparam, base_hparam};
%   name_arr = {'UPF', 'APD'};

%   solver_arr = {@ECG, @APD};
%   hparam_arr = {apgd_hparam, base_hparam};
%   name_arr = {'APGD', 'APD'};
